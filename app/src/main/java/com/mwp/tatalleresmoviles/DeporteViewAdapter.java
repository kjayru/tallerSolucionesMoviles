...
/**
 * Reciclador para categoria deporte
 */
public class DeporteViewAdapter extends RecyclerView.Adapter<DeporteViewAdapter.ViewHolder> {
    ...
    public DeporteViewAdapter(List<Producto> lstProducto) {
    ...
    @Override
    public DeporteViewAdapter.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_listitem, parent, false);
        return  new DeporteViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DeporteViewAdapter.ViewHolder holder, final int position) {
